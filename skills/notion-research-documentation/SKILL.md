...
Use this skill when you need to work with notion-research-documentation.
...
```python
# 使用 notion-research-documentation 技能
skill = load_skill("notion-research-documentation")
