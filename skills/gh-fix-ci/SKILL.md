...
description: 'Use when a user asks to debug or fix failing GitHub PR checks that run
  ...
  draft a fix plan, and implement only after ...'
description_zh:
category: dev-tools
tags:
  - ai
...
Use this skill when you need guidance on gh-fix-ci.
...
python scripts/use-skill.py gh-fix-ci

# View skill details
python scripts/inspect-skill.py gh-fix-ci
```
