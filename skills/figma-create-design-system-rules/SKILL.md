...
Use this skill when you need to work with figma-create-design-system-rules.
...
```python
# 使用 figma-create-design-system-rules 技能
skill = load_skill("figma-create-design-system-rules")
