...
description_zh: 'Document undocumented public APIs in PyTorch by removing functions
  from'
...
Use this skill when you need to work with document-public-apis.
...
```python
# 使用 document-public-apis 技能
skill = load_skill("document-public-apis")
