...
description: Integration guide for Morph's WarpGrep (fast agentic code search) 
  and
...
Use this skill when you need to work with morph-warpgrep.
...
```python
# 使用 morph-warpgrep 技能
skill = load_skill("morph-warpgrep")
