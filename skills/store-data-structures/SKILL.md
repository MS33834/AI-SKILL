...
description: 'LobeHub Zustand store data-shape patterns. Use when designing store
  state,'
description_zh: 'LobeHub Zustand store data-shape patterns. Use when designing store
  state,'
category: dev-tools
tags:
  - ai
...
Use this skill when you need to work with store-data-structures.
...
```python
# 使用 store-data-structures 技能
skill = load_skill("store-data-structures")
