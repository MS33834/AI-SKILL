...
name: github
name_zh: github
description: 'GitHub operations via `gh` CLI: issues, PRs, CI runs, code review, API
  queries. Use when: (1) checking PR status or CI, (2) creating/commenting on issues,
...
Use this skill when you need guidance on github.
