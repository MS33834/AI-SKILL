...
Use this skill when you need guidance on version-release.
...
```bash
# Use the version-release skill
python scripts/use-skill.py version-release

# View skill details
python scripts/inspect-skill.py version-release
```
