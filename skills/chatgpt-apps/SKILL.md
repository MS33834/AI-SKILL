...
description: Build, scaffold, refactor, and troubleshoot ChatGPT Apps SDK 
  applications
description_zh: 构建, scaffold, refactor, and troubleshoot ChatGPT Apps SDK 
  applications
category: dev-tools
tags:
  - ai
...
Use this skill when you need to work with chatgpt-apps.
