...
Use this skill when you need to work with figma-code-connect-components.
...
```python
# 使用 figma-code-connect-components 技能
skill = load_skill("figma-code-connect-components")
