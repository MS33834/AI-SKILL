...
description: Build applications with the Letta API — a model-agnostic, stateful 
  API
...
Use this skill when you need to work with letta-api-client.
...
```python
# 使用 letta-api-client 技能
skill = load_skill("letta-api-client")
