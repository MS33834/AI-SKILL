...
Use this skill when you need guidance on triaging-issues.
...
```bash
# Use the triaging-issues skill
python scripts/use-skill.py triaging-issues

# View skill details
python scripts/inspect-skill.py triaging-issues
```
